...
export async function generateResponse(messages: ChatMessage[]): Promise<string> {
  try {
    ...
    // Se o interlocutor for Julio Campos Machado, proceder
    if (lastMessage.sender === "Julio Campos Machado") {
      ...
      const prompt = `
        ...
        Com a identificação correta de Julio Campos Machado, o sistema deve fornecer as informações de segurança e realizar questionamentos adicionais, mantendo a urgência da situação.
